    ...
    <div className="min-h-screen bg-surface-50 flex flex-col lg:flex-row">
      ...
      >
        <div className="max-w-[380px] mx-auto w-full">
          ...
          <div className="mb-6 p-3.5 rounded-2xl bg-primary/5 border border-primary/15 flex items-center justify-between">
            <div className="text-xs">
              <span className="font-bold text-primary block">Demo Credentials</span>
              <span className="text-textMuted font-mono">demo@traveloop.com / Password123!</span>
            </div>
            <button
              type="button"
              onClick={fillDemoCredentials}
              className="text-xs bg-primary text-white px-3 py-1.5 rounded-xl font-medium hover:bg-primary-dark transition-colors shrink-0"
            >
              Quick Fill
            </button>
          </div>
