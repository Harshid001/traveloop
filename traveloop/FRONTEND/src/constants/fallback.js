...
export const FEATURED_TOP_TRIPS = [
  {
    id: 'top-1',
    title: 'Swiss Alps Alpine Expedition',
    ...
    description: 'Breathtaking peaks, crystal alpine lakes, scenic train rides through Grindelwald and Jungfraujoch.',
    highlights: ['Jungfraujoch Peak', 'Lake Thun Cruise', 'Matterhorn View']
  },
  {
    id: 'top-2',
    title: 'Santorini Sunset & Luxury Villa',
    location: 'Oia, Greece',
    rating: 4.92,
    duration: '5 Days',
    price: '$1,890',
    ...
    description: 'Iconic whitewashed blue-domed architecture, Aegean Sea catamarans, and cliffside infinity pools.',
    highlights: ['Caldera Sunset Cruise', 'Akrotiri Ruins', 'Wine Tasting']
  },
  {
    id: 'top-3',
    title: 'Kyoto Autumn Blossom & Heritage',
    ...
    description: 'Ancient bamboo forests, thousand vermilion torii gates, and peaceful zen gardens.',
  ...
  },
  {
    ...
    description: 'Dramatic vertical towns hugging turquoise waters, lemon groves, and authentic trattorias.',
    highlights: ['Path of the Gods Hike', 'Capri Island Boat Excursion', 'Ravello Gardens']
  },
  {
    id: 'top-5',
    title: 'Tropical Bali Paradise & Spas',
    location: 'Ubud & Canggu, Indonesia',
    rating: 4.87,
    duration: '10 Days',
    price: '$1,450',
    category: 'Beach',
    image: 'https://images.unsplash.com/photo-1537996194471-e657df975ab4?auto=format&fit=crop&w=1400&q=80',
    description: 'Lush green rice terraces, sacred monkey forests, beach clubs, and serene wellness retreats.',
    highlights: ['Tegallalang Rice Terraces', 'Uluwatu Sunset Temple', 'Surfing & Yoga']
  }
];

export const FEATURED_LATEST_TRIPS = [
  {
    id: 'latest-1',
    title: 'Serengeti Wildlife Safari & Zanzibar',
    ...
    description: 'Experience the Great Migration across vast savannahs and unwind on Zanzibar white sand beaches.'
  },
  {
    id: 'latest-2',
    title: 'Nordic Lights & Iceland Glaciers',
    ...
    description: 'Chase the ethereal Aurora Borealis, bathe in natural geothermal lagoons, and explore ice caves.'
  },
  {
    id: 'latest-3',
    title: 'Tokyo Cyberpunk & Mount Fuji',
    ...
    category: 'Cultural',
    image: 'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?auto=format&fit=crop&w=800&q=80',
    description: 'Neon-lit streets of Shinjuku, futuristic robot cafes, and majestic views of snow-capped Mt. Fuji.'
  },
  {
    id: 'latest-4',
    title: 'Paris Museums & Gourmet Tour',
    ...
    category: 'Cultural',
    image: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?auto=format&fit=crop&w=800&q=80',
    description: 'Stroll through Montmartre, admire masterpieces in the Louvre, and savor Michelin-star dining.'
  },
  {
    id: 'latest-5',
    title: 'Dubai Desert Oasis & Marina Towers',
    location: 'Dubai, UAE',
    rating: 4.81,
    duration: '5 Days',
    price: '$2,150',
    category: 'Luxury',
    image: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&w=800&q=80',
    description: 'Soar up Burj Khalifa, speed across golden sand dunes, and relax at luxurious beach resorts.'
  },
  {
    id: 'latest-6',
    title: 'Patagonia Wilderness & Glaciers Trek',
    ...
    description: 'World-class hiking among granite horns, turquoise glacial lakes, and untouched southern wilderness.'
  }
];