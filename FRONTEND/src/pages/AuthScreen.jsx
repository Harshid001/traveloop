  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4">
      ...
      >
        ...
        {/* Glass Card */}
        <div className="bg-white/10 backdrop-blur-[24px] border border-white/20 rounded-3xl p-5 shadow-glow sm:p-8">

          {/* Mode tabs */}
          <div className="flex bg-white/10 rounded-xl p-1 mb-8">
            <button
              onClick={() => setMode('login')}
              className={`min-h-11 flex-1 py-2.5 rounded-lg text-sm font-semibold transition-all duration-300 ${
                mode === 'login'
          ...
          <div className="flex gap-3">
            <button className="flex-1 flex min-h-11 items-center justify-center gap-2 py-2.5 bg-white/10 hover:bg-white/15 border border-white/10 rounded-xl text-white text-sm font-medium transition-all">
        ...
        <div className="text-center mt-6">
          <button
            ...
            className="min-h-11 text-white/40 text-sm hover:text-white/70 transition-colors"
          >
            ← Back to Welcome
          </button>
        </div>
